...
void Car_init(void){
	...
	DCmotor_setSpeedAndDirection(&(carData.rightMotor),0,CLOCK_WISE);
	DCmotor_setSpeedAndDirection(&(carData.leftMotor),0,CLOCK_WISE);
}
...
void Car_MoveBack(void){
	DCmotor_setSpeedAndDirection(&(carData.rightMotor),80,ANTI_CLOCK_WISE);
	DCmotor_setSpeedAndDirection(&(carData.leftMotor),80,ANTI_CLOCK_WISE);
	_delay_ms(800);
	DCmotor_setSpeedAndDirection(&(carData.rightMotor),0,CLOCK_WISE);
	DCmotor_setSpeedAndDirection(&(carData.leftMotor),0,CLOCK_WISE);
